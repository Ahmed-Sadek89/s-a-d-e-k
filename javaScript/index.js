...
import {linksGroupDOM, majorSkillsDOM, minorSkillsDOM, projectsDOM, socialMediaDOM, callMeDOM} from "./AllVariables.js";
console.log(mainStyle)

const AJAX = new fetchDOM();
const {loadingData, errorFetching, getLinks ,getSkills, getProjects, getSocialMedia, getPhoneNumbers} = AJAX;
// AJAX 
...
myRequest.onreadystatechange = function(){
    if(this.readyState === 4 && this.status === 200){ // if status === 200 then the status is success
        ...
        let {Links, MajorSkills, MinorSkills, Projects, socialMedia, call_me} = toJSObject;
        // Links
        getLinks(Links, linksGroupDOM);
        // majorSkills
